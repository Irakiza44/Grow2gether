    ...
    return (
        <div>
            ...
            <div className="login h-full py-4 font-normal ">
                <div className="forg flex justify-center  mx-auto h-5/6 p-4 w-4/12 rounded-2xl mt-12" >
                    <form className=' p-12 flex  flex-col ' onSubmit={handleSignup}>

                        <p className='font-bold text-2xl'>MAKE YOUR APPOINTMENT</p>
                        <label className='mt-16 font-bold text-xl'>Date</label>
                        <input type='text' className='p-2 w-full mt-4 rounded-3xl' placeholder='2023-05-18' onChange={handleInputChange}/>
                        <label className='mt-4 font-bold text-xl'>Reason</label>
                        <textarea type='text' className='px-7 pb-44 w-full mt-4 rounded-3xl' onChange={handleInputChange}/>
