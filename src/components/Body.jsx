        ...
        <div className='bg-black'>
            <body style={{
                ...
                <div className='flex flex-col gap-6 pt-20 ml-12 w-1/5'>
                    <img src={im5} alt='image5' className='w-96 h-64 rounded-3xl' />
                    <img src={im6} alt='image5' className='w-96 h-64 rounded-3xl' />
                ...
                <content className='flex items-center flex-col pt-20 w-3/4'>
                    ...
                    <section className='flex justify-center  text-white mt-20 mb-16'>
                    ...
                    <button className="dropbtn px-6 py-2 font-bold text-3xl  flex gap-2 rounded-3xl shadow-xl shadow-black border-b border-white w-48">Sign In <FaAngleRight /> </button>
